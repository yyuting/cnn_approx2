...
if __name__ == '__main__':
    ...
    if saver_name == 'saver95':
        ...
        in_double_feature = False
        in_less_conv = True
    elif saver_name == 'saver116':
        # a little bit artifact for now, but tolerable
        # still with artifact in 10 runs, giving up on this
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_large'
        in_nlayers = 4
        ...
        in_nlayers = 4
        in_filtersize = 3
    elif saver_name == 'saver123':
        # good, 1 in 4 (5631 weights)
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_large'
        in_nlayers = 4
        ...
        # can't drive weights to 0, but result is good
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_large'
        in_nlayers = 5
        ...
        in_reg_bias = False
        in_regularizer_loss = 'L2'
    elif saver_name == 'saver102':
        # at least 5 in 10
        # 593/2142 at cutoff 0.01
        # can't converge in 10000 iters, but can already have good result
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_large'
        in_nlayers = 5
        ...
        in_less_conv = True
        in_double_feature = False
        in_weight_regularizer = 0.00001
        in_reg_bias = False
        in_iters = 100000
    elif saver_name == 'saver103':
        # good, can drive (523-623/2142) to 0 (at 0.03 - 0.01), 3 in 6
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_large'
        in_nlayers = 5
        ...
        in_less_conv = True
        in_double_feature = False
        in_weight_regularizer = 0.000001
        in_reg_bias = False
    elif saver_name == 'saver113':
        # 549/3267 at 0.01, 3 in 7
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_large'
        in_nlayers = 4
        ...
        in_weight_regularizer = 0.000001
        in_reg_bias = False
    elif saver_name == 'saver122':
        # 520/1656 at 0.01, 2 in 7
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_large'
        in_nlayers = 4
        ...
        in_weight_regularizer = 0.000001
        in_reg_bias = False
    elif saver_name == 'saver130':
        # still, ground is not perfect
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_large'
        in_nlayers = 4
        ...
        in_nlayers = 1
        in_less_conv = True
    elif saver_name == 'saver105':
        # good, can drive (49-57/90) to 0 (at 0.01 - 0.001), 2 in 3
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_small'
        in_nlayers = 1
        ...
        in_weight_regularizer = 0.0001
        in_reg_bias = False
    elif saver_name == 'saver108':
        # good, can drive (24-28/90) to 0 (at 0.01 - 0.001), 2 in 5
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_sharpen_small'
        in_nlayers = 1
        ...
        in_weight_regularizer = 0.00001
        in_reg_bias = False
    elif saver_name == 'saver114':
        # good, 1 in 1
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_blur_approx'
        in_nlayers = 1
    elif saver_name == 'saver118':
        # failed
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_blur_approx'
        in_nlayers = 1
        in_less_conv = True
    elif saver_name == 'saver120':
        # good, 1 in 1, keeps running for now
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_blur_approx'
        in_nlayers = 1
        in_weight_regularizer = 0.00001
        in_reg_bias = False
    elif saver_name == 'saver115':
        # still artifacts in 10 runs, failed
        in_loss = 'L2'
        loss_crop = False
        ...
        in_filtersize = 5
        in_double_feature = False
    elif saver_name == 'saver119':
        # minor artifacts in 9 runs, failed
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_blur_large'
        in_nlayers = 5
        in_filtersize = 5
        in_double_feature = False
    elif saver_name == 'saver126':
        # detailed texture, failed
        in_loss = 'L1'
        loss_crop = False
        app_name = '_test_blur_large'
        in_nlayers = 5
        ...
        in_double_feature = False
        read_from = 'saver119'
    elif saver_name == 'saver125':
        # a lost of detailed texture, failed
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_blur_large'
        in_nlayers = 5
        in_filtersize = 5
    elif saver_name == 'saver121':
        # very good, but not perfect, 2 in 10
        in_loss = 'L2'
        loss_crop = False
        app_name = '_test_blur_large'
        in_nlayers = 5
        in_filtersize = 7
    elif saver_name == 'saver127':
        # good, with very minor artifacts, 1 in 10
        in_loss = 'L1+L2'
        in_scale = 2.0
        loss_crop = False
        app_name = '_test_blur_large'
        ...
        in_nlayers = 5
        in_filtersize = 5
    elif saver_name == 'saver128':
        # good, but not perfect, 1 in 10
        in_loss = 'L1'
        loss_crop = False
        app_name = '_test_blur_large'
        in_nlayers = 5
        in_filtersize = 5
    elif saver_name == 'saver129':
